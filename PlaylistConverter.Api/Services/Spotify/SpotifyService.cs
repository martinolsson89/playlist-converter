...
public class SpotifyService : ISpotifyService
{
    ...
    public async Task<List<string>> GetSpotifyPlaylistAsync(string playlistUrl)
    {
        var playlistId = ExtractPlaylistId(playlistUrl);
        ...
        {
            _logger.LogInformation($"Cache miss for playlist {playlistId}, fetching from Spotify");
